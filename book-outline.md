...
## 第3章：智能AI编程效率提升利器（爽姐 明昊 佐老板）
- 03-第3章：智能AI编程效率提升利器.md
- 03.1-DeepSeek：你的AI编程伙伴.md
- 03.2-Cursor.md
- 03.3-Trae.md
- 03.4-重塑AI编程搜索引擎 Devv AI.md（爽姐）
- 03.5-Claude Code.md（佐老板）  
- 03.6-CodeWhisperer CodeGeeX科大讯飞通义灵码.md
- 03.7-CodeBuddy.md（佐老板）  

## 第4章：AI 赋能代码开发：从生成到优化（爽姐）
...
- 07-第7章：数据分析与可视化.md
- 07.1-网络数据包解析.md（爽姐）
- 07.2-社交网络数据词云图.md（明昊）
- 07.3-AI带你玩转MySQL.md
- 07.4-AI辅助代码转流程图.md
- 07.5-发票归档生成表格.md（佐老板）
